...
`)
    ...
    const headers = {
        ...
        ...data.getHeaders(),
                    ...
                    await message.reply("Gambarnya Mana?")
                }
            }
...
`
        ...
        console.error(randomPick.jawaban)
interval = setInterval(async ()=>{
    console.error(capturedLogs)
...
`
    ...
    if(message.body.startsWith(ytmp4)){
        ...
        if (ytmp4Q){
            try{
                countLimit();
const {ytmp4Dl} = require("./lib/ytmp4.js")
                    await ytmp4Dl(ytmp4Q)
                    .then(async (response) =>{                     
                ...
                console.log(error);
                await message.reply(`Link Tidak tersedia atau kesalahan terjadi.
                ${isdonasi()}
                `);
            }
        }
